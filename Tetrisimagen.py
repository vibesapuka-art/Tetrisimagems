...
# --- MOTOR DE PROCESSAMENTO ESTÁVEL ---
...
st.title("✂️ ScanNCut Pro - Versão Estável")
    ...
    for i, f in enumerate(u):
        with st.expander(f"⚙️ {f.name}", expanded=True):
            ...
            with c3:
                ...
                sang = st.selectbox("Sangria", ["1mm", "3mm", "5mm", "7mm", "9mm"], index=0, key=f"s{i}")
